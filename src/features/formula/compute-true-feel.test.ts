...
/* The bio-calibration block (height/weight/metabolism/clothing) was removed
   2026-07-25 with the feature — no personal data is collected. The ledger-sum
   invariant it also asserted is still covered above. */
